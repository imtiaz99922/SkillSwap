  ...
  try {
    ...
    if (!wallet) {
      wallet = await Wallet.create({
        ...
        creditsBalance: payment.creditsGranted,
        totalCreditsEarned: payment.creditsGranted,
      });
    } else {
      wallet.creditsBalance += payment.creditsGranted;
      wallet.totalCreditsEarned += payment.creditsGranted;
      await wallet.save();
    }
