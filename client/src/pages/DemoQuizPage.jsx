...
const DemoQuizPage = () => {
  ...
  if (loading) {
    return (
      <div className="demo-quiz-page loading-container">
  ...
  if (error) {
    return (
      <div className="demo-quiz-page error-container">
  ...
  if (!quizStarted) {
    return (
      <div className="demo-quiz-page quiz-intro">
  ...
  if (submitted && quizResult) {
    return (
      <div className="demo-quiz-page quiz-results">
  ...
  return (
    <div className="demo-quiz-page quiz-progress">
      {/* Header */}
